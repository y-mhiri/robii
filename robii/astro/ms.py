...
class MS:
    ...
    def readData(self):
        ...
        antenna1 = mainTable.getcol('ANTENNA1', 0, nRows).reshape(-1,1)
        antenna2 = mainTable.getcol('ANTENNA2', 0, nRows).reshape(-1,1)
        uvw_index = np.concatenate((antenna1, antenna2), axis=1)
