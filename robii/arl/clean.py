...
from .image_operations import create_image_from_array
...
def deconvolve_cube(np_dirty, np_psf, params={}):
    ...
    dirty = Image()
    dirty.data = np_dirty.reshape(1, 1, np_dirty.shape[0], np_dirty.shape[1])

    psf = Image()
    psf.data = np_psf.reshape(1, 1, np_psf.shape[0], np_psf.shape[1])
